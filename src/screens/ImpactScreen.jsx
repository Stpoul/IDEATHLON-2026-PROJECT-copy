      ...
      <div className="bg-[var(--primary)] text-white p-6 rounded-3xl shadow-lg mb-6 relative overflow-hidden">
        <div className="relative z-10">
          ...
          <p className="text-sm font-medium flex items-center gap-2">
            <TrendingUp size={16} className="text-emerald-300" /> +12% active students this month
          </p>
        </div>
      ...
      <div className="bg-[var(--card)] border border-[var(--border)] rounded-2xl shadow-sm overflow-hidden mb-6">
        ...
        <div className="p-4">
          <p className="text-sm text-[var(--foreground)] leading-relaxed">
            <strong className="text-[var(--primary)]">Insight:</strong> 72% of 8th graders in the Turnov district swiped right on "I learn better by watching videos than reading."
          </p>
          <p className="text-xs text-[var(--muted-foreground)] mt-3 p-3 bg-slate-100 dark:bg-slate-800 rounded-xl border border-[var(--border)]">
            <strong>Recommendation for Teachers:</strong> Shift next week's curriculum away from textbook reading toward interactive visual media.
          </p>
        </div>
      </div>
