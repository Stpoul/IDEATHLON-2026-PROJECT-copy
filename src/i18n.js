export const TRANSLATIONS = {
  en: {
    ...
    bridge_themes_title: 'Your Discovered Themes',
    bridge_themes_subtitle: 'Based on your swipes so far',
    bridge_theme_vocational: 'Career Interests',
    bridge_theme_vocational_desc: 'How strongly you lean toward hands-on, real-world careers and vocations.',
    bridge_theme_pedagogical: 'Learning Style',
    bridge_theme_pedagogical_desc: 'How clearly defined your preferred way of learning already is.',
    bridge_theme_lifestyle: 'Lifestyle Readiness',
    bridge_theme_lifestyle_desc: 'How open you are to new environments, independence, and bold life choices.',
  ...
  cz: {
    ...
    // BridgeScreen — under16 Skill Themes view
    bridge_themes_title: 'Tvá objevená témata',
    bridge_themes_subtitle: 'Na základě tvých dosavadních voleb',
    bridge_theme_vocational: 'Kariérní zájmy',
    bridge_theme_vocational_desc: 'Jak silně tíhneš k praktickým kariérám a profesím.',
    bridge_theme_pedagogical: 'Styl učení',
    bridge_theme_pedagogical_desc: 'Jak jasně definovaný je tvůj preferovaný způsob učení.',
    bridge_theme_lifestyle: 'Připravenost na samostatnost',
    bridge_theme_lifestyle_desc: 'Jak otevřený/á jsi novému prostředí, nezávislosti a odvážným životním rozhodnutím.',
    bridge_theme_match: 'Shoda',
    bridge_themes_no_swipes: 'Dokonči karty Objevuj a uvidíš svá objevená témata!',
    // BridgeScreen — Generate Regional CV
